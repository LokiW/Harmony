...
public class HarmonyHorse extends EntityHorse {
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        if (this.riddenByEntity == null || !(this.riddenByEntity instanceof EntityLivingBase) || !this.isHorseSaddled()) {
            /*
            System.out.println("HarmonyMod: strafe " + strafe + " forward " + forward +
                                " set strafe " + this.moveStrafing +
                                " set forward " + this.moveForward +
                                " mount x " + this.posX +
                                " prev x " + this.prevPosX +
                                " server x " + this.serverPosX +
                                " mount z " + this.posZ +
                                " prev z " + this.prevPosZ +
                                " server z " + this.serverPosZ);
        ...
        System.out.println("HarmonyMod: player x " + this.riddenByEntity.posX +
                    " mount x " + this.posX +
                    " prev x " + this.prevPosX +
                    " player z " + this.riddenByEntity.posZ +
                    " mount z " + this.posZ +
                    " prev z " + this.prevPosZ);
